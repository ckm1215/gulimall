...
import com.ckm.gulimall.product.entity.CommentReplay;
import com.ckm.gulimall.product.service.CommentReplayService;
import com.ckm.gulimall.product.mapper.CommentReplayMapper;
import org.springframework.stereotype.Service;

/**
* @author ASUS
* @description 针对表【pms_comment_replay(商品评价回复关系)】的数据库操作Service实现
* @createDate 2022-08-04 16:15:40
*/
@Service
