...
import com.ckm.gulimall.product.entity.AttrGroup;
import com.ckm.gulimall.product.service.AttrGroupService;
import com.ckm.gulimall.product.mapper.AttrGroupMapper;
import org.springframework.stereotype.Service;

/**
* @author ASUS
* @description 针对表【pms_attr_group(属性分组)】的数据库操作Service实现
* @createDate 2022-08-04 16:15:13
*/
@Service
